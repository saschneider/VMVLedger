...
Rails.application.configure do
  ...
  # In the development environment your application's code is reloaded on every request. This slows down response time but is perfect for development since you
  # don't have to restart the web server when you make code changes.
  ...
  # Perform all jobs inline as async just mucks up SQLite unless overridden.
  if ENV['DELAYED_JOBS'].present?
